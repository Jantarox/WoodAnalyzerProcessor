...
Section "!${PRODUCT_NAME}" sec_app
  ...
  ; Create image directories
      ...
      CreateDirectory "$INSTDIR\images\org"
      CreateDirectory "$INSTDIR\images\seg"
  ...
  SetOutPath "$INSTDIR"
    CreateShortCut "$SMPROGRAMS\Wood Analyzer.lnk" "$INSTDIR\WoodAnalyzer.jar" \
...
Section "Uninstall"
  ...
  ; Uninstall shortcuts
    Delete "$SMPROGRAMS\Wood Analyzer.lnk"
